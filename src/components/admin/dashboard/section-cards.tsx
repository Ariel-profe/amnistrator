...
export function SectionCards({totalPayments, primitivoEquipments, buciEquipments, moldesEquipments}: Props) {
    return (
        <div className="flex w-full flex-col gap-4 sm:grid sm:grid-cols-2 lg:grid-cols-4 @container/card:gap-6">
            <Card className="@container/card">
                <CardHeader>
                    <CardDescription>Total de abonos:</CardDescription>
                    <CardTitle className="text-2xl font-semibold text-center tabular-nums @[250px]/card:text-3xl">{totalPayments}</CardTitle>
                    <CardAction>
